        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-indigo-500 to-indigo-300 mr-3">
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-green-500 to-green-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-light-blue-500 to-light-blue-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-red-500 to-red-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-yellow-500 to-yellow-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="flex-grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full flex-shrink-0 bg-gradient-to-tr from-gray-500 to-gray-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
