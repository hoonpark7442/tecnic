        ...
        <table class="table-auto w-full">
          ...
          <tbody class="text-sm divide-y divide-gray-100">
            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 rounded-full mr-2 sm:mr-3 bg-indigo-500">
            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 rounded-full mr-2 sm:mr-3 bg-green-500">
            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 rounded-full mr-2 sm:mr-3 bg-light-blue-500">
                    <svg class="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 rounded-full mr-2 sm:mr-3 bg-red-500">
                    <svg class="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
