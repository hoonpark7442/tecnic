<template>
  <div class="flex-grow flex flex-col md:translate-x-0 transform transition-transform duration-300 ease-in-out" :class="profileSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'">
    ...
    <div class="relative px-4 sm:px-6 pb-8">
      ...
      <div class="-mt-16 mb-6 sm:mb-3">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
          ...
          <div class="flex space-x-2 sm:mb-2">
            <button class="p-1.5 flex-shrink-0 rounded border border-gray-200 hover:border-gray-300 shadow-sm">
            ...
            <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">
              <svg class="fill-current flex-shrink-0" width="11" height="8" viewBox="0 0 11 8">
      ...
      <header class="text-center sm:text-left mb-6">
        ...
        <div class="inline-flex items-start mb-2">
          ...
          <svg class="w-4 h-4 fill-current flex-shrink-0 text-yellow-500 ml-2" viewBox="0 0 16 16">
          ...
          <div>
            ...
            <div class="grid xl:grid-cols-2 gap-4">
              ...
              <div class="bg-white p-4 border border-gray-200 rounded-sm shadow-sm">
                <!-- Card header -->
                <div class="flex-grow flex items-center truncate mb-2">
                  <div class="w-8 h-8 flex-shrink-0 flex items-center justify-center bg-gray-700 rounded-full mr-2">
            ...
            <div class="bg-white p-4 border border-gray-200 rounded-sm shadow-sm">
              <ul class="space-y-3">
                ...
                <li class="sm:flex sm:items-center sm:justify-between">
                  <div class="sm:flex-grow flex items-center text-sm">
                    <!-- Icon -->
                    <div class="w-8 h-8 rounded-full flex-shrink-0 bg-yellow-500 my-2 mr-3">
                ...
                <li class="sm:flex sm:items-center sm:justify-between">
                  <div class="sm:flex-grow flex items-center text-sm">
                    <!-- Icon -->
                    <div class="w-8 h-8 rounded-full flex-shrink-0 bg-indigo-500 my-2 mr-3">
