<template>
  <div class="flex-grow flex flex-col md:translate-x-0 transform transition-transform duration-300 ease-in-out" :class="inboxSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'">
    ...
    <div class="sticky top-16">
      <div class="flex items-center justify-between bg-gray-50 border-b border-gray-200 px-4 sm:px-6 md:px-5 h-16">
        ...
        <div class="flex">
          ...
          <button class="p-1.5 flex-shrink-0 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm ml-2">
    ...
    <!-- Body -->
    <div class="flex-grow px-4 sm:px-6 md:px-5 py-4">
    ...
    <div class="sticky bottom-0">
      <div class="flex items-center justify-between bg-white border-t border-gray-200 px-4 sm:px-6 md:px-5 h-16">
        <!-- Plus button -->
        <button class="flex-shrink-0 text-gray-400 hover:text-gray-500 mr-3">
