  ...
  setup() {
    ...
    const categoryIcon = (category) => {
      switch (category) {
        case '1':
          return (
            `<div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-red-500">
        ...
        case '3':
          return (
            `<div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-light-blue-500">
        ...
        case '4':
          return (
            `<div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-indigo-500">
