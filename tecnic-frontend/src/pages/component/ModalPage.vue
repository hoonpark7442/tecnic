                    ...
                    <ModalBlank id="success-modal" :modalOpen="successModalOpen" @close-modal="successModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-green-100">
                          <svg class="w-4 h-4 flex-shrink-0 fill-current text-green-500" viewBox="0 0 16 16">
                    ...
                    <ModalBlank id="danger-modal" :modalOpen="dangerModalOpen" @close-modal="dangerModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-red-100">
                          <svg class="w-4 h-4 flex-shrink-0 fill-current text-red-500" viewBox="0 0 16 16">
                    ...
                    <ModalBlank id="info-modal" :modalOpen="infoModalOpen" @close-modal="infoModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-indigo-100">
                          <svg class="w-4 h-4 flex-shrink-0 fill-current text-indigo-500" viewBox="0 0 16 16">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="newsletter-modal" :modalOpen="newsletterModalOpen" @close-modal="newsletterModalOpen = false">
                      ...
                      <div class="mb-2 text-center">
                        <!-- Icon -->
                        <div class="mb-3">
                          <svg class="inline-flex w-12 h-12 rounded-full flex-shrink-0 fill-current" viewBox="0 0 48 48">
