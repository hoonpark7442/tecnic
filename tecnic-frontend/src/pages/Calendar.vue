              ...
              <ul class="flex flex-wrap items-center -m-1">
                <li class="m-1">
                  <button class="btn-sm bg-white border-gray-200 hover:border-gray-300 text-gray-500">
                    <div class="w-1 h-3.5 bg-light-blue-500 flex-shrink-0"></div>
                    <span class="ml-1.5">Acme Inc.</span>
                  </button>
                </li>
                <li class="m-1">
                  <button class="btn-sm bg-white border-gray-200 hover:border-gray-300 text-gray-500">
                    <div class="w-1 h-3.5 bg-green-500 flex-shrink-0"></div>
                    <span class="ml-1.5">Life & Family</span>
                  </button>
                </li>
                <li class="m-1">
                  <button class="btn-sm bg-white border-gray-200 hover:border-gray-300 text-gray-500">
                    <div class="w-1 h-3.5 bg-indigo-500 flex-shrink-0"></div>
                    <span class="ml-1.5">Reservations</span>
                  </button>
                </li>
                <li class="m-1">
                  <button class="btn-sm bg-white border-gray-200 hover:border-gray-300 text-gray-500">
                    <div class="w-1 h-3.5 bg-red-400 flex-shrink-0"></div>
                    <span class="ml-1.5">Events</span>
                  </button>
                </li>
                <li class="m-1">
                  <button class="btn-sm bg-white border-gray-200 hover:border-gray-300 text-gray-500">
                    <div class="w-1 h-3.5 bg-yellow-500 flex-shrink-0"></div>
            ...
            <div class="grid grid-cols-7 gap-px bg-gray-200">
              ...
              <div class="relative bg-white h-20 sm:h-28 lg:h-36 overflow-hidden" v-for="(day, index) in daysInMonth" :key="index">
                <div class="h-full flex flex-col justify-between">
                  <!-- Events -->
                  <div class="flex-grow flex flex-col relative p-0.5 sm:p-1.5 overflow-hidden">
                    <button
