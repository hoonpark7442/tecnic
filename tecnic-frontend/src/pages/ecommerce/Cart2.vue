    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <main>
        <div class="lg:relative lg:flex">
          ...
          <!-- Content -->
          <div class="px-4 sm:px-6 lg:px-8 py-8 lg:flex-grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
          ...
          <!-- Sidebar -->
          <div>
            <div class="lg:sticky lg:top-16 bg-gray-50 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:flex-shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 lg:w-[320px] xl:w-[352px] 2xl:w-[calc(352px+80px)] lg:h-[calc(100vh-64px)]">
