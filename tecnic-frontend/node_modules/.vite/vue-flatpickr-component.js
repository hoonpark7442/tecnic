import {
  ...
  slotFlagsText,
  toHandlerKey
} from "./chunk-M4JKCSY6.js";
import {
  __commonJS,
  __esm,
  __export
} from "./chunk-FPJRMZPJ.js";
...
var require_vue_flatpickr_min = __commonJS({
  "node_modules/vue-flatpickr-component/dist/vue-flatpickr.min.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t((init_esm(), esm_exports), require_vue()) : typeof define == "function" && define.amd ? define("VueFlatpickr", ["flatpickr", "vue"], t) : typeof exports == "object" ? exports.VueFlatpickr = t((init_esm(), esm_exports), require_vue()) : e.VueFlatpickr = t(e.flatpickr, e.Vue);
    }(self, function(e, t) {
      return (() => {
        "use strict";
        var n = { 69: (t2) => {
        ...
        return (() => {
          ...
          const p = n2.concat(["onValueUpdate", "onDayCreate", "onParseConfig", "onReady", "onPreCalendarPosition", "onKeyDown"]), f = ["locale", "showMonths"], d = { name: "flat-pickr", render() {
          ...
          }, emits: ["blur", "update:modelValue"].concat(p.map(o2)), props: { modelValue: { default: null, required: true, validator: (e3) => e3 === null || e3 instanceof Date || typeof e3 == "string" || e3 instanceof String || e3 instanceof Array || typeof e3 == "number" }, config: { type: Object, default: () => ({ wrap: false, defaultDate: null }) }, events: { type: Array, default: () => n2 }, disabled: { type: Boolean, default: false } }, data: () => ({ fp: null }), mounted() {
            if (this.fp)
              return;
            let e3 = l(this.config);
            this.events.forEach((n3) => {
              let r2 = t2().defaultConfig[n3] || [];
              e3[n3] = i(e3[n3] || []).concat(r2, (...e4) => {
                this.$emit(o2(n3), ...e4);
              });
            });
            e3.onClose = i(e3.onClose || []).concat((...e4) => {
              this.onClose(...e4);
            }), e3.defaultDate = this.modelValue || e3.defaultDate, this.fp = new (t2())(this.getElem(), e3), this.fpInput().addEventListener("blur", this.onBlur), this.$watch("disabled", this.watchDisabled, { immediate: true });
          }, methods: { getElem() {
            ...
            p.forEach((e4) => {
              ...
              t3[e4] !== void 0 && this.fp.set(e4, t3[e4]);
            });
          } }, modelValue(e3) {
            e3 !== s(this.$refs.root.value) && this.fp && this.fp.setDate(e3, true);
          } }, beforeUnmount() {
            this.fp && (this.fpInput().removeEventListener("blur", this.onBlur), this.fp.destroy(), this.fp = null);
          } };
          d.install = (e3, t3) => {
            let n3 = "flat-pickr";
            typeof t3 == "string" && (n3 = t3), e3.component(n3, d);
          };
          const h = d;
        })(), a = a.default;
      })();
