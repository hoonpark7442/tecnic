...
ActiveRecord::Schema.define(version: 2021_07_25_004210) do
  ...
  create_table "posts_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
